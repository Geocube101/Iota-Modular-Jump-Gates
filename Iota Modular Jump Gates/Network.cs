...
{
	public enum MyPacketTypeEnum : byte {
		DOWNLOAD_GRID, UPDATE_GRIDS, UPDATE_GRID,
		UPDATE_JUMP_GATE, UPDATE_DRIVE, UPDATE_CAPACITOR, UPDATE_CONTROLLER, UPDATE_REMOTE_ANTENNA, UPDATE_REMOTE_LINK,
		UPDATE_JUMP_ENDPOINT, UPDATE_EVENT_CONTROLLER_EVENT, UPDATE_CONFIG,
	...
	internal class MyNetworkInterface
	{
		...
		/// </summary>
		private static double MaxPacketDeltaMS => 10000;
		#endregion
