...
{
	public enum MyPacketTypeEnum { DOWNLOAD_GRID, UPDATE_GRIDS, UPDATE_GRID, UPDATE_JUMP_GATE, UPDATE_DRIVE, UPDATE_CAPACITOR, UPDATE_CONTROLLER, UPDATE_JUMP_ENDPOINT, UPDATE_EVENT_CONTROLLER_EVENT, CLOSE_BLOCK, CLOSE_GRID, JUMP_GATE_JUMP, JUMP_GATE_VOID_IN, JUMP_GATE_VOID_OUT, STATICIFY_CONSTRUCT, COMM_LINKED, BEACON_LINKED, AUTOACTIVATE, SHEARWARNING };
