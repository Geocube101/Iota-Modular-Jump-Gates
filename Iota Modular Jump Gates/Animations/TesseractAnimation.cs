...
namespace IOTA.ModularJumpGates.Animations
{
	...
	{
		private static Vector3D Tesseract_StandardColor => new Vector3D(0.5, 0.625, 1);
		private static Vector3D Tesseract_FestiveRedColor => new Vector3D(1, 0.125, 0.25);
		private static Vector3D Tesseract_FestiveGreenColor => new Vector3D(0.125, 1, 0.25);
		private static Vector3D Tesseract_FestiveBlueColor => new Vector3D(0.375, 0.5, 1);
		private static Vector3D Tesseract_FestiveWhiteColor => new Vector3D(0.75, 0.875, 1);

		public AnimationDef TesseractAnimation = new AnimationDef("Tesseract", "A nested tesseract jump gate animation", random_weight: 150)
		{
			Enabled = true,
					...
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_StandardColor, 1)),
							},
					...
					FlashPointParticles = new ParticleDef[] {
						new ParticleDef {
							...
							Animations = new AttributeAnimationDef {
								...
								ParticleColorAnimation = new VectorKeyframe[] {
									new VectorKeyframe(0, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(Tesseract_StandardColor, 1), upper: new Vector4D(1, 0.625, 0.5, 1)),
									new VectorKeyframe(120, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(Tesseract_StandardColor, 1), upper: new Vector4D(1, 0.625, 0.5, 1)),
									new VectorKeyframe(180, Vector4D.Zero),
								},
							},
						},
					}
			...
			FailedAnimationDef = new JumpGateFailedAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_StandardColor, 1), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_IN),
		...
		public AnimationDef TesseractAnimation_Festive1 = new AnimationDef("Tesseract", "A nested tesseract jump gate animation", random_weight: 25)
		{
			Enabled = true,
			...
			JumpingAnimationDef = new JumpGateJumpingAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_FestiveGreenColor, 1)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, 0d, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new DoubleKeyframe(60, AnimationSourceEnum.JUMP_GATE_SIZE, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_IN) * 0.625,
					...
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_FestiveRedColor, 1)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, 0d, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new DoubleKeyframe(60, AnimationSourceEnum.JUMP_GATE_SIZE, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_IN) * 0.375,
			...
			JumpedAnimationDef = new JumpGateJumpedAnimationDef
			{
				...
				BeamPulse = new BeamPulseDef
				{
					...
					{
						ParticleColorAnimation = new VectorKeyframe[] {
							new VectorKeyframe(0, 1, EasingCurveEnum.SINE, EasingTypeEnum.EASE_IN_OUT, RatioTypeEnum.ENDPOINT_DISTANCE, new Vector4D(Tesseract_FestiveGreenColor, 1), new Vector4D(Tesseract_FestiveRedColor, 1)),
							new VectorKeyframe(240, Vector4D.Zero),
						},
						ParticleRadiusAnimation = new DoubleKeyframe[] {
							new DoubleKeyframe(0, 0d, ratio_type: RatioTypeEnum.RANDOM, lower: 0.25, upper: 1) * AnimationSourceEnum.JUMP_GATE_SIZE / 25,
					...
					FlashPointParticles = new ParticleDef[] {
						new ParticleDef {
							...
							Animations = new AttributeAnimationDef {
								...
								ParticleColorAnimation = new VectorKeyframe[] {
									//new VectorKeyframe(0, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(Tesseract_StandardColor, 1), upper: new Vector4D(1, 0.625, 0.5, 1)),
									new VectorKeyframe(120, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(Tesseract_FestiveGreenColor, 1), upper: new Vector4D(Tesseract_FestiveRedColor, 1)),
									new VectorKeyframe(180, Vector4D.Zero),
								},
							},
						},
			...
			FailedAnimationDef = new JumpGateFailedAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_FestiveGreenColor, 1), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_IN),
								new VectorKeyframe(300, new Vector4D(1, 0.5, 0.25, 1)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, 0d, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
					...
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_FestiveRedColor, 1), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_IN),
								new VectorKeyframe(300, new Vector4D(1, 0.5, 0.25, 1)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, 0d, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
		...
		public AnimationDef TesseractAnimation_Festive2 = new AnimationDef("Tesseract", "A nested tesseract jump gate animation", random_weight: 25)
		{
			Enabled = true,
			...
			JumpingAnimationDef = new JumpGateJumpingAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_FestiveBlueColor, 1)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, 0d, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new DoubleKeyframe(60, AnimationSourceEnum.JUMP_GATE_SIZE, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_IN) * 0.625,
					...
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_FestiveWhiteColor, 1)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, 0d, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new DoubleKeyframe(60, AnimationSourceEnum.JUMP_GATE_SIZE, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_IN) * 0.375,
			...
			JumpedAnimationDef = new JumpGateJumpedAnimationDef
			{
				...
				BeamPulse = new BeamPulseDef
				{
					...
					{
						ParticleColorAnimation = new VectorKeyframe[] {
							new VectorKeyframe(0, 1, EasingCurveEnum.SINE, EasingTypeEnum.EASE_IN_OUT, RatioTypeEnum.ENDPOINT_DISTANCE, new Vector4D(Tesseract_FestiveBlueColor, 1), new Vector4D(Tesseract_FestiveWhiteColor, 1)),
							new VectorKeyframe(240, Vector4D.Zero),
						},
						ParticleRadiusAnimation = new DoubleKeyframe[] {
							new DoubleKeyframe(0, 0d, ratio_type: RatioTypeEnum.RANDOM, lower: 0.25, upper: 1) * AnimationSourceEnum.JUMP_GATE_SIZE / 25,
					...
					FlashPointParticles = new ParticleDef[] {
						new ParticleDef {
							...
							Animations = new AttributeAnimationDef {
								...
								ParticleColorAnimation = new VectorKeyframe[] {
									//new VectorKeyframe(0, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(Tesseract_StandardColor, 1), upper: new Vector4D(1, 0.625, 0.5, 1)),
									new VectorKeyframe(120, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(Tesseract_FestiveBlueColor, 1), upper: new Vector4D(Tesseract_FestiveWhiteColor, 1)),
									new VectorKeyframe(180, Vector4D.Zero),
								},
							},
						},
			...
			FailedAnimationDef = new JumpGateFailedAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_FestiveBlueColor, 1), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_IN),
								new VectorKeyframe(300, new Vector4D(1, 0.5, 0.25, 1)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, 0d, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
					...
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(Tesseract_FestiveWhiteColor, 1), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_IN),
								new VectorKeyframe(300, new Vector4D(1, 0.5, 0.25, 1)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, 0d, EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
