...
namespace IOTA.ModularJumpGates.Animations
{
	public partial class AnimationDefinitions
	{
		...
		private static Vector3D MagicSigil_StandardColor => new Vector3D(0.5, 0.625, 1);
		private static Vector3D MagicSigil_FestiveRedColor => new Vector3D(1, 0.125, 0.25);
		private static Vector3D MagicSigil_FestiveGreenColor => new Vector3D(0.125, 1, 0.25);
		private static Vector3D MagicSigil_FestiveBlueColor => new Vector3D(0.375, 0.5, 1);
		private static Vector3D MagicSigil_FestiveWhiteColor => new Vector3D(0.75, 0.875, 1);

		public AnimationDef MagicSigilAnimation = new AnimationDef("Magic Sigil", random_weight: 150)
		{
			Enabled = true,
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(MagicSigil_StandardColor, 0), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(60, new Vector4D(MagicSigil_StandardColor, 0.01)),
							},
			...
			JumpedAnimationDef = new JumpGateJumpedAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(240, new Vector4D(MagicSigil_StandardColor, 0.01), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(300, new Vector4D(MagicSigil_StandardColor, 0)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE) * 0.625,
							},
		...
		public AnimationDef MagicSigilAnimation_Festive1 = new AnimationDef("Magic Sigil", random_weight: 25)
		{
			Enabled = true,
			...
			JumpingAnimationDef = new JumpGateJumpingAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(MagicSigil_FestiveRedColor, 0), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(60, new Vector4D(MagicSigil_FestiveRedColor, 0.01)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE) * 0.625,
							},
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(MagicSigil_FestiveGreenColor, 0), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(60, new Vector4D(MagicSigil_FestiveGreenColor, 0.01)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE),
							},
			...
			JumpedAnimationDef = new JumpGateJumpedAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(240, new Vector4D(MagicSigil_FestiveRedColor, 0.01), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(300, new Vector4D(MagicSigil_FestiveRedColor, 0)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE) * 0.625,
							},
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(240, new Vector4D(MagicSigil_FestiveGreenColor, 0.01), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(300, new Vector4D(MagicSigil_FestiveGreenColor, 0)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE),
							},
				...
				BeamPulse = new BeamPulseDef
				{
					...
					Animations = new AttributeAnimationDef
					{
						ParticleColorAnimation = new VectorKeyframe[] {
							//new VectorKeyframe(0, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(0.5, 0.625, 1, 1), upper: new Vector4D(1, 0.625, 0.5, 1)),
							new VectorKeyframe(240, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(MagicSigil_FestiveGreenColor, 1), upper: new Vector4D(MagicSigil_FestiveRedColor, 1)),
							new VectorKeyframe(300, Vector4D.Zero),
						},
						ParticleRadiusAnimation = new DoubleKeyframe[] {
							new DoubleKeyframe(0, 0d, ratio_type: RatioTypeEnum.RANDOM, lower: 0.25, upper: 1) * AnimationSourceEnum.JUMP_GATE_SIZE / 25,
					...
					FlashPointParticles = new ParticleDef[] {
						new ParticleDef {
							...
							Animations = new AttributeAnimationDef {
								...
								ParticleColorAnimation = new VectorKeyframe[] {
									//new VectorKeyframe(0, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(0.5, 0.625, 1, 1), upper: new Vector4D(1, 0.625, 0.5, 1)),
									new VectorKeyframe(180, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(MagicSigil_FestiveRedColor, 1), upper: new Vector4D(MagicSigil_FestiveGreenColor, 1)),
									new VectorKeyframe(240, Vector4D.Zero),
								},
							},
						},
			...
			AnimationConstraints = new AnimationConstraintDef[] {
				new AnimationConstraintDef {
					AllowedDate = Util.DateTimeRange.Single(new DateTime(1970, 12, 1), Util.DateTimeRange.ComponentCompareType.MONTH),
				}
			},
		};

		public AnimationDef MagicSigilAnimation_Festive2 = new AnimationDef("Magic Sigil", random_weight: 25)
		{
			Enabled = true,
			...
			JumpingAnimationDef = new JumpGateJumpingAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(MagicSigil_FestiveBlueColor, 0), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(60, new Vector4D(MagicSigil_FestiveBlueColor, 0.01)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE) * 0.625,
							},
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(MagicSigil_FestiveWhiteColor, 0), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(60, new Vector4D(MagicSigil_FestiveWhiteColor, 0.01)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE),
							},
			...
			JumpedAnimationDef = new JumpGateJumpedAnimationDef
			{
				...
				NodeParticles = new ParticleDef[] {
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(240, new Vector4D(MagicSigil_FestiveBlueColor, 0.01), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(300, new Vector4D(MagicSigil_FestiveBlueColor, 0)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE) * 0.625,
							},
					...
					new ParticleDef {
						...
						Animations = MagicSigil_Animation = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(240, new Vector4D(MagicSigil_FestiveWhiteColor, 0.01), EasingCurveEnum.CIRCULAR, EasingTypeEnum.EASE_OUT),
								new VectorKeyframe(300, new Vector4D(MagicSigil_FestiveWhiteColor, 0)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE),
							},
				...
				BeamPulse = new BeamPulseDef
				{
					...
					Animations = new AttributeAnimationDef
					{
						ParticleColorAnimation = new VectorKeyframe[] {
							//new VectorKeyframe(0, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(0.5, 0.625, 1, 1), upper: new Vector4D(1, 0.625, 0.5, 1)),
							new VectorKeyframe(240, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(MagicSigil_FestiveWhiteColor, 1), upper: new Vector4D(MagicSigil_FestiveBlueColor, 1)),
							new VectorKeyframe(300, Vector4D.Zero),
						},
						ParticleRadiusAnimation = new DoubleKeyframe[] {
							new DoubleKeyframe(0, 0d, ratio_type: RatioTypeEnum.RANDOM, lower: 0.25, upper: 1) * AnimationSourceEnum.JUMP_GATE_SIZE / 25,
					...
					FlashPointParticles = new ParticleDef[] {
						new ParticleDef {
							...
							Animations = new AttributeAnimationDef {
								...
								ParticleColorAnimation = new VectorKeyframe[] {
									//new VectorKeyframe(0, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(0.5, 0.625, 1, 1), upper: new Vector4D(1, 0.625, 0.5, 1)),
									new VectorKeyframe(180, Vector4D.One, ratio_type: RatioTypeEnum.ENDPOINT_DISTANCE, lower: new Vector4D(MagicSigil_FestiveBlueColor, 1), upper: new Vector4D(MagicSigil_FestiveWhiteColor, 1)),
									new VectorKeyframe(240, Vector4D.Zero),
								},
							},
						},
