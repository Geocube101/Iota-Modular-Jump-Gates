...
namespace IOTA.ModularJumpGates.Animations
{
	...
	{
		static ParticleDef[] IMJG_Warp_DriveParticles;

		public AnimationDef StandardWarp = new AnimationDef("Warp", "The standard SE warp effect")
		{
			Enabled = true,
			...
			JumpingAnimationDef = new JumpGateJumpingAnimationDef
			{
				...
				PerDriveParticles = IMJG_Warp_DriveParticles = new ParticleDef[] {
					new ParticleDef {
						ParticleNames = new string[] { "IOTA.Warp.DriveParticleJumping.ShimmerRing" },
						CleanOnEffectEnd = false,
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(0.701169, 1, 0.9743, 1)),
							},
						},
					},
					new ParticleDef {
				...
				PerAntiDriveParticles = IMJG_Warp_DriveParticles,
				...
				NodeSounds = new SoundDef[] {
					new SoundDef {
						SoundNames = new string[] { "ShipJumpDriveCharging" },
					},
				},
				...
				{
					Duration = 600,
					EmissiveColor = new Color(new Vector4D(0.701169, 1, 0.9743, 1)),
					Brightness = 10,
				},
			},
			...
			JumpedAnimationDef = new JumpGateJumpedAnimationDef {
				...
				AntiNodeParticles = new ParticleDef[] {
					new ParticleDef {
						...
						Animations = new AttributeAnimationDef {
							ParticleColorAnimation = new VectorKeyframe[] {
								new VectorKeyframe(0, new Vector4D(0.701169, 1, 0.9743, 1)),
								new VectorKeyframe(180, new Vector4D(0.701169, 1, 0.9743, 0)),
							},
							ParticleScaleAnimation = new DoubleKeyframe[] {
								new DoubleKeyframe(0, AnimationSourceEnum.JUMP_GATE_SIZE),
				...
				AntiNodeSounds = new SoundDef[] {
					new SoundDef {
						SoundNames = new string[]{ "ShipJumpDriveJumpIn" },
					},
				},
			...
			FailedAnimationDef = new JumpGateFailedAnimationDef {
				...
				NodeSounds = new SoundDef[] {
					new SoundDef {
						SoundNames = new string[]{ "IOTA.Warp.JumpGateFailed" },
					},
				},
